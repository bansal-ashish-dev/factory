            ...
            <>
              <div className="relative flex h-full">
                <Popover.Button
                  ...
                  className="relative h-full flex items-center transition-all ease-out duration-200 focus:outline-hidden hover:text-ui-fg-base p-2"
                >
                  <Menu size={20} />
                </Popover.Button>
              </div>
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-y-6">
                      ...
                      <Text className="flex justify-between txt-compact-small">
                        © {new Date().getFullYear()} Thread Buy. All rights
                        reserved.
                      </Text>
                    </div>
                  </div>
