...
import LoginRequirementNotice from "../login-requirement-notice"
    ...
    <Container>
      ...
      <div>
        <div className={isOpen ? "block" : "hidden"}>
          {!customer && (
            <div className="mb-6">
              <LoginRequirementNotice message="You must be logged in to complete your payment and place the order." />
            </div>
          )}
          {!paidByGiftcard && availablePaymentMethods?.length && (
            <>
              ...
              >
                {availablePaymentMethods
                  .sort((a, b) => {
                    // Prioritize manual payment for testing
                    if (a.id === "pp_system_default") return -1
                    if (b.id === "pp_system_default") return 1
